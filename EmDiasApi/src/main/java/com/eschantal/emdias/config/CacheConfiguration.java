package com.eschantal.emdias.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("emdias");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("emdias");
        ...
        config.getMapConfigs().put("com.eschantal.emdias.domain.*", initializeDomainMapConfig(jHipsterProperties));
