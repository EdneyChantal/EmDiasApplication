...
SELECT pg_catalog.setval('public.tbconfigextrato_idconfigextrato_seq', 44, true);
...
SELECT pg_catalog.setval('public.tbmovementbank_idmovementbank_seq', 1451, true);
