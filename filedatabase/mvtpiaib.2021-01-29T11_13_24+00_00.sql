...
SELECT pg_catalog.setval('public.tbconfigextrato_idconfigextrato_seq', 50, true);
...
SELECT pg_catalog.setval('public.tbmovementbank_idmovementbank_seq', 1491, true);
...
SELECT pg_catalog.setval('public.tbnatureplan_id_natureplan_seq', 41, true);
